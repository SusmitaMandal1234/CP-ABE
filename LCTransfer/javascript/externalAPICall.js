...
async function main() {
    try {
        ...
        let chaincode_id = "LC-Transfer3"
        
        const contract = network.getContract(chaincode_id);
        let result = await contract.submitTransaction('GetCarFromExternalContract', 'CAR0');
        console.log("result", JSON.parse(result.toString()));
        
        //by api call, it's possible
        // axios({
        //     method: 'get',
        //     url: 'http://localhost:3000/cars/CAR0',
        //     data: {}
        //   })
